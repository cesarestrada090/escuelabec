...
- Name: pipeline.spec.ts >> Pipeline - Kanban >> muestra el pipeline con 6 columnas
- Location: e2e/tests/pipeline.spec.ts:12:7
...
Call log:
  ...
  - waiting for locator('.kanban-column')
